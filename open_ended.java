...
class Health extends Insurance{
    ...
    private String [] hospitals = {"Apollo Hospitals", "Max Hospitals/Clinics", "Smile Clinic", "JayPee Hospital", "Holy family Hospital", "Indian Hospital", "International Modern Hospital", "Gangaram Speciality Hospital", "SMS Hospitals/Clinics"};
...
class open_ended extends formatter{
    private static String USERNAME = "Admin";
    private static String PASSWORD = "abc123";
    private static Scanner input = new Scanner(System.in);
    private static String ID_h = "ThkH02020/";                              
    ...
    public static void leave() {
        refreshScreen();
	    System.out.println("\n\t\t*****\n");
        System.out.println("\n\t\tTHANK YOU \n\tFor Using The Amity Insurance Portal!\n\tWe Hope To See You Again!\n");
        transitionBuffer();
        System.exit(0);
    }
    ...
    public static int Kidharhai(String id){                            
        if(id.charAt(3) == 'H'){
            return 1;
        }
